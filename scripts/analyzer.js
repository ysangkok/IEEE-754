...
$().ready(function() {
    ...
    function keyboard_shortcuts(event) {
        ...
        case 'ctrl+b':
            ...
            break;
        case 'ctrl+h':
            $('#force-hexadecimal').focus();
            break;
        case 'ctrl+l':
            $('#force-little-endian').focus();
            break;
        case 'ctrl+v':
            $('#value-entered').focus();
            break;
        case 'ctrl+up':
            $('#force-round-pos-infinity').focus();
            break;
        case 'ctrl+down':
            $('#force-round-neg-infinity').focus();
            break;
        case 'ctrl+0':
            $('#force-round-zero').focus();
            break;
        case 'ctrl+n':
            $('#force-round-nearest-value').focus();
            break;
        default:
            alert('Unrecognized keyboard input: ' + event.data);
        }
    ...
    function() {
        window.location = $('#faq')[0].getAttribute('href');
    });
            ...
            var cb = function(value) {
                ...
                if (value.isValid) {
                    if (value.isInfinity) {
                        ...
                        if (n == 'qNaN') {
                            analyzer.hex64_fraction_value.nodeValue = '1xxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxx';
                        } else {
                            analyzer.hex64_fraction_value.nodeValue = '01xxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxx';
                        }
                        ...
                        if (n == 'qNaN') {
                            analyzer.hex128_fraction_value.nodeValue = '1xxxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx';
                        } else {
                            analyzer.hex128_fraction_value.nodeValue = '01xxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx' + 'xxxxxxxxxxxxxxxxxxxxxxxxxxxx';
                        }
    ...
    function clickHandler(evt) {
        ...
        $("#block" + num).html("<div class='identifier'><p>Analyzer " + num + "</p></div>" + "<img class='idle loading' id='loading" + num + "' title='progress' src='./images/ajax-loader.gif' alt=''/>" + "<fieldset class='input_format'>" + "  <legend><span class='analyzerlabel'>Input Format</span></legend>" + "  <div>" + "  <input type='radio' name='input-format" + num + "' value='auto' id='force-auto" + num + "' checked='checked' />" + "<label for='force-auto" + num + "'>auto</label>" + "</div>" + "<div>" + " <input type='radio' name='input-format" + num + "' value='decimal' id='force-decimal" + num + "' />" + "<label for='force-decimal" + num + "'>decimal</label>" + "</div>" + "<div>" + "<input type='radio' name='input-format" + num + "' value='binary' id='force-binary" + num + "' />" + "<label for='force-binary" + num + "'>binary</label>" + "</div>" + "<div>" + "<input type='radio' name='input-format" + num + "' value='hexadecimal' id='force-hexadecimal" + num + "' />" + "<label for='force-hexadecimal" + num + "'>hexadecimal</label>" + "</div>" + "<div class='input-option'> " + "  <input type='checkbox' name='little-endian' id='force-little-endian" + num + "'" + "  class='little-endian' disabled='disabled' /> " + "  <label for='force-little-endian" + +num + "'>Hexadecimal is little-endian " + "  (right-to-left)</label>" + "</div> " + "</fieldset>" + "<fieldset class='rounding_format'><legend>" + "<span class='analyzerlabel'>Rounding Mode</span></legend>" + "<div>" + "<input type='radio' name='rounding-format" + num + "' value='round-nearest-value' id='force-round-nearest-value" + num + "' checked='checked'  />" + "<label for='force-round-nearest-value" + num + "'>Round to the Nearest Value </label>           " + "</div>" + "<div>" + "<input type='radio' name='rounding-format" + num + "' value='round-zero' id='force-round-zero" + num + "' />" + "<label for='force-round-zero" + num + "'>Round toward Zero </label>          " + "</div>" + "<div>" + "<input type='radio' name='rounding-format" + num + "' value='round-pos-infinity' id='force-round-pos-infinity" + num + "' />" + "<label for='force-round-pos-infinity" + num + "'>Round toward Positive Infinity </label>            " + "</div>" + "<div>" + "<input type='radio' name='rounding-format" + num + "' value='round-neg-infinity' id='force-round-neg-infinity" + num + "' />" + "<label for='force-round-neg-infinity" + num + "'>Round toward Negative Infinity </label>" + "</div>" + "</fieldset>" + "<fieldset class='value_enter'>    " + "<legend><span class='analyzerlabel'>Value to analyze:</span></legend>" + "<input type='text' id='value-entered" + num + "' class='value-entered' />  " + "<p><span class='analyzerlabel'>Syntax Entered:</span> <span id='syntax_msg" + num + "'>none</span></p>" + "</fieldset>" + "<div id='result" + num + "' class='result'>   " + "<div class='dec_and_bin_results'>" + "<p><span class='analyzerlabel'>Decimal value:</span> <span id='decimal_value" + num + "'>0</span></p>" + "<p><span class='analyzerlabel'>Normalized binary value:</span>" + " <span id='binary_value" + num + "'>0</span></p>" + "</div>" + "<div class = 'hex32'>" + "<p><span class='analyzerlabel'>Binary32:</span> <span id='hex32_value" + num + "' class='hex32Value' >--</span></p> " + "<div id='hex32_sef" + num + "' class='hex32sef'>" + "<table>" + "<tr id='hex32_sef_labels" + num + "' class='hex32_sef_labels'>" + "<th><span class='analyzerlabel'>Status</span></th>" + "<th><span class='analyzerlabel'>Sign [1]</span></th>" + "<th><span class='analyzerlabel'>Exponent [8]</span></th>" + "<th><span class='analyzerlabel'>Significand [23]</span></th>" + "</tr>" + "<tr id='hex32_sef_results" + num + "' class='hex32_sef_results'>" + "<td><span id='hex32_status" + num + "'>---</span></td>" + "<td><span id='hex32_sign_value" + num + "'>-</span> (<span id='hex32_sign_symbol" + num + "'>-</span>)</td>" + "<td><span id='hex32_exponent_value" + num + "'>--</span> (<span id='hex32_decimal_exponent_value" + num + "'>--</span>)</td>" + "<td><span id='hex32_fraction_value" + num + "'>--</span> (<span id='hex32_decimal_fraction_value" + num + "'>--</span>)</td>" + "</tr>" + "</table>" + "</div>" + "</div>" + "<div class = 'hex64'>" + "<p><span class='analyzerlabel'>Binary64:</span> <span id='hex64_value" + num + "' class='hex64Value'>--</span></p> " + "<div id='hex64_sef" + num + "' class='hex64sef'>" + "<table>" + "<tr id='hex64_sef_labels" + num + "' class='hex64_sef_labels'>" + "<th><span class='analyzerlabel'>Status</span></th>" + "<th><span class='analyzerlabel'>Sign [1]</span></th>" + "<th><span class='analyzerlabel'>Exponent [11]</span></th>" + "<th><span class='analyzerlabel'>Significand [52]</span></th>" + "</tr>" + "<tr id='hex64_sef_results" + num + "' class='hex64_sef_results'>" + "<td><span id='hex64_status" + num + "'>---</span></td>" + "<td><span id='hex64_sign_value" + num + "'>-</span> (<span id='hex64_sign_symbol" + num + "'>-</span>)</td>" + "<td><span id='hex64_exponent_value" + num + "'>--</span> (<span id='hex64_decimal_exponent_value" + num + "'>--</span>)</td>" + "<td><span id='hex64_fraction_value" + num + "'>--</span> (<span id='hex64_decimal_fraction_value" + num + "'>--</span>)</td>" + "</tr>" + "</table>" + "</div> " + "</div> " + "<div class = 'hex128'>" + "<p><span class='analyzerlabel'>Binary128:</span> <span id='hex128_value" + num + "' class='hex128Value'>--</span></p> " + "<div id='hex128_sef" + num + "' class='hex128sef'>" + "<table>" + "<tr id='hex128_sef_labels" + num + "' class='hex128_sef_labels'>" + "<th><span class='analyzerlabel'>Status</span></th>" + "<th><span class='analyzerlabel'>Sign [1]</span></th>" + "<th><span class='analyzerlabel'>Exponent [15]</span></th>" + "<th><span class='analyzerlabel'>Significand [112]</span></th>" + "</tr>" + "<tr id='hex128_sef_results" + num + "' class='hex128_sef_results'>" + "<td><span id='hex128_status" + num + "'>---</span></td>" + "<td><span id='hex128_sign_value" + num + "'>-</span> (<span id='hex128_sign_symbol" + num + "'>-</span>)</td>" + "<td><span id='hex128_exponent_value" + num + "'>--</span> (<span id='hex128_decimal_exponent_value" + num + "'>--</span>)</td>" + "<td><span id='hex128_fraction_value" + num + "'>--</span> (<span id='hex128_decimal_fraction_value" + num + "'>--</span>)</td>" + "</tr>" + "</table>" + "</div>" + "</div>" + "</div> " + "<button id='kill-this-analyzer" + num + "' class='kill-this-analyzer' >Close This Analyzer</button>");
